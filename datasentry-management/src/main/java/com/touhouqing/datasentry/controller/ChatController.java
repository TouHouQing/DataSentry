...
import com.touhouqing.datasentry.dto.ChatMessageDTO;
import com.touhouqing.datasentry.entity.ChatMessage;
import com.touhouqing.datasentry.entity.ChatSession;
import com.touhouqing.datasentry.service.chat.ChatMessageService;
import com.touhouqing.datasentry.service.chat.ChatSessionService;
import com.touhouqing.datasentry.service.chat.SessionTitleService;
import com.touhouqing.datasentry.util.ReportTemplateUtil;
...
public class ChatController {
	...
	public ResponseEntity<List<ChatSession>> getAgentSessions(@PathVariable(value = "id") Long id) {
	...
	public ResponseEntity<ChatSession> createSession(@PathVariable(value = "id") Long id,
	...
	public ResponseEntity<ApiResponse> clearAgentSessions(@PathVariable(value = "id") Long id) {
