 ...
 */
package com.touhouqing.datasentry.service.datasource.impl;

import com.touhouqing.datasentry.bo.DbConfigBO;
import com.touhouqing.datasentry.dto.datasource.SchemaInitRequest;
...
import com.touhouqing.datasentry.mapper.AgentDatasourceTablesMapper;
import com.touhouqing.datasentry.service.datasource.AgentDatasourceService;
...
public class AgentDatasourceServiceImpl implements AgentDatasourceService {
	...
	@Override
	public Boolean initializeSchemaForAgentWithDatasource(Long agentId, Long datasourceId, List<String> tables) {
	...
	@Override
	@Transactional
	public AgentDatasource addDatasourceToAgent(Long agentId, Long datasourceId) {
	...
	@Override
	public void removeDatasourceFromAgent(Long agentId, Long datasourceId) {
		agentDatasourceMapper.removeRelation(agentId, datasourceId);
	}

	@Override
	public AgentDatasource toggleDatasourceForAgent(Long agentId, Long datasourceId, Boolean isActive) {
	...
	@Override
	@Transactional
	public void updateDatasourceTables(Long agentId, Long datasourceId, List<String> tables) {
