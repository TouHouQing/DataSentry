 ...
 */
package com.touhouqing.datasentry.service.semantic;

import com.touhouqing.datasentry.dto.schema.SemanticModelAddDTO;
import com.touhouqing.datasentry.dto.schema.SemanticModelBatchImportDTO;
import com.touhouqing.datasentry.dto.schema.SemanticModelImportItem;
import com.touhouqing.datasentry.entity.AgentDatasource;
import com.touhouqing.datasentry.entity.SemanticModel;
...
public class SemanticModelServiceImpl implements SemanticModelService {
	...
	public List<SemanticModel> getByAgentIdAndTableNames(Long agentId, List<String> tableNames) {
		Long datasourceId = findDatasourceIdByAgentId(agentId);
	...
	public boolean addSemanticModel(SemanticModelAddDTO dto) {
		...
		Long datasourceId = findDatasourceIdByAgentId(dto.getAgentId());
	...
	private Long findDatasourceIdByAgentId(Long agentId) {
